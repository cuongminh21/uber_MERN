...
router.post('/register',[
    ...
    body('vehicle.capacity').isLength({min:1}).withMessage('Capacity must be at least 6 characters long'),
    body('vehicle.vehicleType').isIn(['car','motor','auto']).withMessage('Invalid vehicle type'),
],
